      ...
      >
        ...
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: "0.5rem", textDecoration: "none" }}>
          ...
          <span style={{ fontWeight: 600, color: "inherit" }}>
            Anshul<span className="text-gradient">verse</span>
          </span>
        </Link>
          ...
          {navLinks.map((link) => (
            <Link
              ...
              style={{
                ...
                fontWeight: 500,
                textDecoration: "none",
                color: pathname === link.href ? "var(--color-brand-600)" : "inherit",
                backgroundColor: pathname === link.href ? "var(--color-brand-50)" : "transparent",
