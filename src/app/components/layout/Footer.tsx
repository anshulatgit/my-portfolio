...
const socialLinks = [
  { icon: Github, href: "https://github.com/anshulatgit", label: "GitHub" },
  { icon: Twitter, href: "https://twitter.com/ans_hul", label: "Twitter" },
  { icon: Linkedin, href: "https://linkedin.com/in/anshul-jain-8b2902216", label: "LinkedIn" },
  { icon: Mail, href: "mailto:ajphysiciston@gmail.com", label: "Email" },
];
      ...
      <div className="container-max section-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-semibold text-gray-900 dark:text-white">AnshulJain.dev</span>
            </div>
        ...
        <div className="pt-6 border-t border-gray-200 dark:border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-3">
          <p className="text-xs text-gray-500 dark:text-gray-500">
            © {new Date().getFullYear()} Anshul Jain. Built with Next.js & Tailwind CSS.
          </p>
          <p className="text-xs text-gray-500 dark:text-gray-500 flex items-center gap-1">
            Open source on
            <a href="https://github.com/anshulatgit/portfolio" target="_blank" className="text-brand-500 hover:underline flex items-center gap-0.5">
