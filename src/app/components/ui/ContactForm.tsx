    ...
    return (
      <div style={{ textAlign: "center", padding: "3rem 1rem" }}>
        ...
        <button
          ...
          style={{ padding: "0.625rem 1.5rem", backgroundColor: "var(--color-brand-600)", color: "white", border: "none", borderRadius: "0.625rem", fontWeight: 700, cursor: "pointer" }}
        >
          Send Another
        </button>
      </div>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1rem" }}>
        <div>
          ...
          <input name="name" value={form.name} onChange={handleChange}
            ...
            style={{ ...inputStyle, borderColor: errors.name ? "#ef4444" : "rgba(148,163,184,0.2)" }} />
        ...
        <div>
          ...
          <input name="email" type="email" value={form.email} onChange={handleChange}
            ...
            style={{ ...inputStyle, borderColor: errors.email ? "#ef4444" : "rgba(148,163,184,0.2)" }} />
      ...
      <div>
        ...
        <input name="subject" value={form.subject} onChange={handleChange}
          ...
          style={{ ...inputStyle, borderColor: errors.subject ? "#ef4444" : "rgba(148,163,184,0.2)" }} />
      ...
      <div>
        ...
        <textarea name="message" value={form.message} onChange={handleChange}
          rows={5} placeholder="Tell me more..."
          style={{ ...inputStyle, resize: "none", borderColor: errors.message ? "#ef4444" : "rgba(148,163,184,0.2)" }} />
      ...
      <button onClick={handleSubmit} disabled={status === "loading"}
        style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", padding: "0.875rem", background: "linear-gradient(135deg, var(--color-brand-600), var(--color-accent))", color: "white", border: "none", borderRadius: "0.75rem", fontWeight: 700, fontSize: "0.9rem", cursor: status === "loading" ? "not-allowed" : "pointer", opacity: status === "loading" ? 0.7 : 1 }}>
        {status === "loading" ? (
